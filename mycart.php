...
Remove
  ...
  ?>
     <a href="index.php" class="btn btn-danger" style="font-weight:bold">Total Price- <?=$t[0]?>  /-</a>
          ...
          <a href="mpesa.php?price=<?=$t[0]?>"><span class="btn btn-success">mpesa</span></a>
     	 <?php
  }
	 ?>
  </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This  is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Mohamed</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
