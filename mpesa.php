...
if(isset($_POST['submit'])){
    ...
    $amount = '4847'; //Amount to transact 
    ...
    $headers = array(
        ...
        'ApiKey: fXpehUs2h9D' // Replace with your api key
     );
    ...
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            ...
            <?php
                ...
                {extract($t);
                ?>
            <div class="px-5"> <span class="button mt-3 d-block bg-white p-2" name="amount"><?=$t[0]?></span> </div>
            <br>
            <?php
  }
	 ?>
